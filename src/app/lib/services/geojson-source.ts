...
export class GeoJsonSource {
  ...
  // public get mapsource() {
  //   return this.mapsource;
  // }
  // public set mapsource(value) {
  ...
  public saveFile(filename, pretty: boolean = true) {
    ...
    a.href = 'data:application/json;charset=utf-8,\ufeff' + encodeURIComponent(this.toString(pretty));
    a.download = filename;
    a.click();
  }
  ...
  //判断是否设置地图图片
  private addImage;
  public get _addImage() {
    return this.addImage;
  }
  public set _addImage(value: boolean) {
    this.addImage = value;
  ...
  public setImageSrc() {
    ...
    geojson.features.forEach(feature => {
      const img = new Image();
      img.src = "https://i.postimg.cc/" + feature.properties.iso + '/image.png';
