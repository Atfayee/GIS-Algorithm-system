...
import { GeoJsonSource, GeoJSON2String } from 'src/app/lib/services/geojson-source';
...
export class HelloTurfService {
  ...
  public buffer() {
    ...
    const buffered = turf.buffer(this.geojsonSource.geojson, this.buffer_radius, { units: 'kilometers' });
