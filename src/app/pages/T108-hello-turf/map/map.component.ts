...
export class MapComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.map.addLayer(this.service.bufferSource.maplayer);
    this.map.addLayer(this.service.geojsonSource.maplayer);
  }
  ...
  public onLocationFeature(sid) {
    const geo = this.service.activeSource.getFeatureBySid(sid);
